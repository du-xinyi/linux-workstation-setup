...
- **本机常用开发库**：`libboost-all-dev`（完整 Boost 开发库）、`zlib1g-dev`、`libssl-dev`、
  `libcurl4-openssl-dev`、`nlohmann-json3-dev`、
  `libfmt-dev`、`libspdlog-dev`、`libsqlite3-dev`、`libeigen3-dev`、`libgtest-dev`/`libgmock-dev`、
  `catch2`、`libxml2-dev`、`libyaml-cpp-dev`、`libbenchmark-dev`、`liblz4-dev`、`libzstd-dev`。
  设 `CPP_COMMON_LIBS=0` 可跳过。
